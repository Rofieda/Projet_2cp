    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Qualite', models.CharField(choices=[('Enseignant-Chercheur', 'Enseignant-Chercheur'), ('Chercheur', 'Chercheur'), ('Doctorant', 'Doctorant'), ('Autre', 'Autre')], max_length=100)),
                ...
                ('statut', models.CharField(choices=[('Active', 'Active'), ('Non Active', 'Non Active')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intitule', models.CharField(default=None, max_length=200)),
                ...
                ('role_chercheur2', models.CharField(choices=[('encadreur', 'Encadreur'), ('co_encadreur', 'Co_encadreur')], default='', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Projet',
