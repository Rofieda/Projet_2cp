...
from .models import Chercheur ,ChecheursProjets , Projet , Encadrement ,Conf_journal ,Publication,ChecheursEncadrements
...
class ProjetDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta: 
        model = Projet
        fields = ['id_projet','titre_projet', 'chef_de_projet', 'domaine', 'annee_debut', 'annee_fin', 'membre_liste']
...
class ProjetDetailSerializerSecond(serializers.ModelSerializer):
    ...
    class Meta: 
        model = Projet
        fields = ['id_projet','titre_projet', 'chef_de_projet', 'domaine', 'annee_debut', 'annee_fin']
...
class ChercheurDetailSerializer(serializers.ModelSerializer):
    class Meta: 
        model =Chercheur 
        exclude = ['id_chercheur','conf_journals','encadrements','projet']
...
class ChercheurListSerializer(serializers.ModelSerializer):
    ...
    class Meta: 
        model = Chercheur 
        fields = ['id_chercheur','nom_chercheur', 'grade_recherche', 'email','statut','detail_url']
...
class PublicationSerializerFF(serializers.ModelSerializer):
    conf_journal_acronyme = serializers.CharField(source='Conf_Journal_id.acronyme', read_only=True)
    conf_journal_nom = serializers.CharField(source='Conf_Journal_id.nom', read_only=True)

    class Meta:
        model = Publication
        fields = ['annee', 'titre_publication', 'volume', 'lien_publie', 'nombre_page', 'rang_chercheur',
                  'conf_journal_acronyme', 'conf_journal_nom']
